                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <label className="block text-sm font-medium mb-1">Public IP Host (Use <a target="_blank" rel="noopener noreferrer" className="text-blue-600 underline" href="https://whatismyipaddress.com/">WhatIsMyIp</a> or check on WinBox IP/Cloud)</label>
                                    <input
                                        type="text"
                                        name="publicIP"
                                        value={publicIP}
