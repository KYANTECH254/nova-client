            ...
            >
                <div className="flex flex-row gap-2 justify-items-start items-center">
                    ...
                    <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
                        <h1 className="text-white text-2xl sm:text-3xl font-bold tracking-wide">{name} Portal</h1>
                    </div>
                    <button
                        onClick={toggleProfile}
                        className="fixed top-4 right-4 z-30 p-2 rounded-md bg-gray-900 shadow-lg"
                    >
                        <div className="flex flex-row items-center justify-center">
                            <User size={40} className="w-6 h-6 text-gray-100" />
                            {!isOpenUser ? (<ChevronDown size={16} className="text-gray-100 font-bold" />) : (<ChevronUp size={16} className="text-gray-100 font-bold" />)}
                        </div>
